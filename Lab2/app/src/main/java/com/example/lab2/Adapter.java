...
public class Adapter extends BaseAdapter {
    ...
    private int layout;
    private List<com.example.payroll.Staff> arraylist;


    public Adapter(Context context, int layout, ArrayList<com.example.payroll.Staff> arrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        com.example.payroll.Staff staff = this.arraylist.get(i);
